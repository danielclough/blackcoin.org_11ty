module.exports = {
  ...
  homepage: {
    'zh': '主页', /*Chinese*/
    'es': 'Página principal', /*Spanish*/
    'en': 'Homepage', /*English*/
    'hi': 'कालाधन', /*Hindi*/
    'ar': 'الصفحة الرئيسية', /*Arabic - Right-to-left*/
    'pt': 'Carregando', /*Portuguese*/
    'bn': 'হোমপেজ', /*Bengal*/
    'ru': 'Домашняя страница', /*Russian*/
    'ja': 'ホームページ', /*Japanese*/
    'jv': 'Kaca Ngarep', /*Javanese*/
    'de': 'Startseite', /*German*/
    'ko': '홈페이지', /*Korean*/
    'fr': 'Page d\'accueil', /*French*/
    'te': 'బ్లాక్ కాయిన్', /*Telugu*/
    'mr': 'मुख्यपृष्ठ', /*Marathi*/
    'tr': 'Yükleniyor', /*Turkish*/
    'ta': 'முகப்புப்பக்கம்', /*Tamil*/
    'vi': 'Trang chủ', /*Vietnamese*/
    'ur': 'ہوم پیج', /*Urdu - Right-to-left*/
    'nl': 'Startpagina', /*Dutch*/
    'it': 'Homepage',  /*Italian*/
    'hr': 'Početna stranica' /*Croatian*/
  },
  ...
  loading: {
    ...
    'es': 'Cargando', /*Spanish*/
    'en': 'Loading', /*English*/
    'hi': 'लोड हो रहा है', /*Hindi*/
    'ar': 'جار التحميل', /*Arabic - Right-to-left*/
    'pt': 'Selecione o idioma', /*Portuguese*/
    'bn': 'লোড হচ্ছে', /*Bengal*/
    'ru': 'Загрузка', /*Russian*/
    'ja': '読み込み中 ', /*Japanese*/
    'jv': 'Ngunggah', /*Javanese*/
    'de': 'Wird geladen', /*German*/
    'ko': '로딩 중 ', /*Korean*/
    'fr': 'Chargement', /*French*/
    'te': 'లోడ్', /*Telugu*/
    'mr': 'लोड करीत आहे', /*Marathi*/
    'tr': 'Dil Seçin', /*Turkish*/
    'ta': 'ஏற்றுகிறது', /*Tamil*/
    'vi': 'Đang tải', /*Vietnamese*/
    'ur': 'لوڈ ہو رہا ہے', /*Urdu - Right-to-left*/
    'nl': 'Bezig met laden', /*Dutch*/
    'it': 'Caricamento in corso',  /*Italian*/
    'hr': 'Učitavam' /*Croatian*/
  },
  blackcoin: {
    'zh': '黑币', /*Chinese*/
